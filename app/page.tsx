...
export default function Home() {
  ...
  const announcements = [
    {
      title: "ดาวน์โหลดเกียรติบัตร (ประเภทเดี่ยว)",
      date: "7 ก.ย. 2568",
      description: "ผู้เข้าร่วมการแข่งขันประเภทเดี่ยวเครื่องดนตรีและขับร้อง สามารถดาวน์โหลดเกียรติบัตรได้แล้ว",
      href: "https://kku.world/cer-tmc24"
    },
    {
      title: "ประกาศผลการประกวดเดี่ยวเครื่องดนตรีและขับร้อง",
      date: "6 ก.ย. 2568",
      description: "ประกาศผลการแข่งขันประเภทเดี่ยวเครื่องดนตรีและขับร้อง ทุกระดับชั้น สามารถตรวจสอบผลการแข่งขันได้แล้ว",
      href: "/result"
    },
    {
